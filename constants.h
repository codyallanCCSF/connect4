/* file: constants.h
   ...
   DO NOT EDIT THIS FILE!!!
	 If you declare other global constants, please put 
	 them in Connect4.cpp, rather than this file.
   */

#ifndef CONNECT_4_CONSTANTS_H
#define CONNECT_4_CONSTANTS_H
#include <string>
